//! Testnet acceptance tests for `smart-account migrate-verifier`.
//!
...
//!
//! ```text
//! cargo test --features testnet-integration --test smart_account_migrate_verifier_testnet_acceptance
//! ```
//!
