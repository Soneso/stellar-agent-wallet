...
/// The OZ spending-limit-policy WASM hash from the compile-time single-entry
/// allowlist (`crate::spending_limit_policy::SPENDING_LIMIT_POLICY_WASM_SHA256`,
/// hex-decoded).
///
/// Value: `0e8da0ccff5c444520085ac1973d3c8023fdd04f727ee11ae7290a49dffbbaf5`
/// (OZ multisig-spending-limit-policy-example v0.7.2, SHA `a9c4216`).
pub const KNOWN_SPENDING_LIMIT_WASM_HASH: [u8; 32] = [
    0x0e, 0x8d, 0xa0, 0xcc, 0xff, 0x5c, 0x44, 0x45, 0x20, 0x08, 0x5a, 0xc1, 0x97, 0x3d, 0x3c, 0x80,
    0x23, 0xfd, 0xd0, 0x4f, 0x72, 0x7e, 0xe1, 0x1a, 0xe7, 0x29, 0x0a, 0x49, 0xdf, 0xfb, 0xba, 0xf5,
];

/// The OZ weighted-threshold-policy WASM hash from the compile-time
/// single-entry allowlist
/// (`crate::weighted_threshold_policy::WEIGHTED_THRESHOLD_POLICY_WASM_HASHES[0]`).
///
/// Value: `e3d8cc5ab9668526d5cf2bab17ee42e84ee4b972ba7cca8d3a37b2ed8d9baee3`
/// (OZ multisig-weighted-threshold-policy-example v0.7.2, SHA `a9c4216`).
pub const KNOWN_WEIGHTED_THRESHOLD_WASM_HASH: [u8; 32] = [
