//! `stellar-agent wallet sa deploy-webauthn-verifier` subcommand.
//!
...
/// Arguments for the `wallet sa deploy-webauthn-verifier` subcommand.
///
...
/// Runs the `wallet sa deploy-webauthn-verifier` subcommand.
///
