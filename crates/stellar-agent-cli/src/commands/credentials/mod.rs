...
impl CredentialsArgs {
    ...
    pub(crate) fn profile_flag(&self) -> Option<&str> {
        match &self.subcommand {
            CredentialsSubcommand::AddPasskey(a) => a.profile.as_deref(),
            CredentialsSubcommand::List(a) => a.profile.as_deref(),
            CredentialsSubcommand::Delete(a) => a.profile.as_deref(),
            CredentialsSubcommand::Show(a) => a.profile.as_deref(),
        }
    }
}
