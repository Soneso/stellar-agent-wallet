...
impl CounterpartyArgs {
    ...
    pub(crate) fn profile_flag(&self) -> Option<&str> {
        match &self.subcommand {
            CounterpartySubcommand::List(a) => a.profile.as_deref(),
            CounterpartySubcommand::Refresh(a) => a.profile.as_deref(),
            CounterpartySubcommand::Evict(a) => a.profile.as_deref(),
            CounterpartySubcommand::WarmUp(a) => a.profile.as_deref(),
            CounterpartySubcommand::RotateHmacKey(a) => a.profile.as_deref(),
        }
    }
}
