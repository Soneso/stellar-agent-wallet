...
//!
//! Sourced from the canonical bitcoin/bips BIP-0039 English word list.
//! Reference copy at `stellar-php-sdk/Soneso/StellarSDK/SEP/Derivation/wordlists/english.txt`.
//! Used exclusively by `secret_patterns::assert_no_secret_bytes` to detect
//! mnemonic phrases that must never reach log output.

/// The BIP-39 English word list, sorted lexicographically.
///
/// Used by [`crate::secret_patterns::assert_no_secret_bytes`] for mnemonic detection.
pub(crate) static BIP39_ENGLISH: [&str; 2048] = [
    ...
    "sing", "siren", "sister", "situate", "six", "size", "skate", "sketch", "ski", "toolset",
