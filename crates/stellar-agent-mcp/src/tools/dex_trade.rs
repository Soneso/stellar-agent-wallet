...
impl WalletServer {
    ...
    async fn stellar_dex_trade(
        ...
        // dispatch gate below is consumed, the signer is loaded, or the swap
        // is submitted. Reused (not re-acquired) for `DefiAdapterCtx::audit_writer`.
        ...
        // (non-fatal past this point — the pre-flight above is what fails
        // closed).
