    ...
    async fn stellar_create_account_commit(
        ...
        let recorder = match crate::tools::submission_record::build_recorder(
            crate::tools::submission_record::CommitRecord {
                ...
                descriptor: self.tool_registry.get("stellar_create_account_commit"),
                value_class,
        ...
        .await
        {
            Ok(SubmissionResult {
                ...
                // decision = "committed" fires on confirmed ledger inclusion,
                // so a submission failure does not record a committed decision.
                tracing::info!(
                    tool = "stellar_create_account_commit",
                    chain = %args.chain_id,
                    nonce_id = %nonce_id_prefix,
