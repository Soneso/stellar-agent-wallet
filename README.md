...
```bash
curl -fsSLO https://github.com/Soneso/stellar-agent-wallet/releases/download/v0.1.0-alpha.7/stellar-agent-0.1.0-alpha.7-aarch64-apple-darwin.tar.xz
tar -xJf stellar-agent-0.1.0-alpha.7-aarch64-apple-darwin.tar.xz
```
