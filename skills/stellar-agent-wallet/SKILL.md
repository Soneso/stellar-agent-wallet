...
license: Apache-2.0
compatibility: Requires the stellar-agent CLI and stellar-agent-mcp server (v0.1.0-alpha.7 public alpha; install from crates.io with a pinned version, e.g. cargo binstall stellar-agent-cli@0.1.0-alpha.7 stellar-agent-mcp@0.1.0-alpha.7, or build from source). Targets Stellar testnet (default) and mainnet.
metadata:
  version: "0.4.5"
  wallet_version: "0.1.0-alpha.7"
---
...
cargo binstall stellar-agent-cli@0.1.0-alpha.7 stellar-agent-mcp@0.1.0-alpha.7
# Or build from the published sources:
cargo install stellar-agent-cli@0.1.0-alpha.7 stellar-agent-mcp@0.1.0-alpha.7
```
