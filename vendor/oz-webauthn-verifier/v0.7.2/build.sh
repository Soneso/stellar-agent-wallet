#!/usr/bin/env bash
# Reproducibility script for vendor/oz-webauthn-verifier/v0.7.2/multisig_webauthn_verifier_example.wasm.
# Usage: ./vendor/oz-webauthn-verifier/v0.7.2/build.sh
...
ARTEFACT_DIR="${WORKSPACE_ROOT}/vendor/oz-webauthn-verifier/v0.7.2"
...
echo ""
echo "Update vendor/oz-webauthn-verifier/v0.7.2/PROVENANCE.md with the values above"
