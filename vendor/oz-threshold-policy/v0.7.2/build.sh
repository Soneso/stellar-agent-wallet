#!/usr/bin/env bash
# Reproducibility script for vendor/oz-threshold-policy/v0.7.2/multisig_threshold_policy_example.wasm.
# Usage: ./vendor/oz-threshold-policy/v0.7.2/build.sh
...
ARTEFACT_DIR="${WORKSPACE_ROOT}/vendor/oz-threshold-policy/v0.7.2"
...
echo ""
echo "Update vendor/oz-threshold-policy/v0.7.2/PROVENANCE.md with the values above"
